...
const Holiday = () => {
    ...
    const url = "/calendar/holiday/addholiday";
    ...
    const handlePost = async (e) => {
       ...
       if(!holidaydate)
       {
        errors.holidaydate = "Date is required"
       ...
       setvalidate(errors)
        try {
            ...
            saveHoliday && NotificationManager.success("Successfully Created")
            saveHoliday && window.location.replace("/holidays")
                    ...
                    <Form type="submit" onSubmit={handlePost}>
                        <Form.Group>
                            ...
                            <Form.Select onChange={handleInput}  >
                                ...
                                <option  selected disabled>Calendar</option>
                            ...
                            <Form.Group className="mb-3 mt-4" controlId="formBasicEmail">
                                ...
                                <Form.Control type="date" name="holidaydate" onChange={(e) => { setholidaydate(e.target.value) }} />    
                            </Form.Group>
                            {validation.holidaydate && <p style={{color:"red",fontSize:"13px"}}>{validation.holidaydate}</p>}
