        ...
        <div className="card">
          <div className="card-body">
            <div className="d-flex flex-column align-items-center text-center">
             {data.profilepic ?  <img src={PP + data.profilepic} alt="Admin" className="rounded-circle" width={150} />: <img src={pp} alt="Admin" className="rounded-circle" width={150} />}
              <div className="mt-3">
                <div style={{display:"flex",justifyContent:"center"}}><h4>{data.firstname }</h4><span style={{marginLeft:"4px"}}></span><h4 >{data.lastname }</h4></div>
                
                <p className="text-secondary mb-1">{data.designation}</p>
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-sm-9 text-secondary">
               <div style={{display:"flex"}}><div>{data.firstname}</div> <span style={{marginLeft:"6px"}}></span> <div>{data.lastname}</div></div>  
