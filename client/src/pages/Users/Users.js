...
const Users = () => {
  ...
  useEffect(() => {
    ...
    console.log("localstorage", JSON.parse(localStorage.getItem("timesheet_user437")) &&  JSON.parse(localStorage.getItem("timesheet_user437")).details )

    if (JSON.parse(localStorage.getItem("timesheet_user437")) &&  JSON.parse(localStorage.getItem("timesheet_user437")).details.role == "Super Admin" )
    ...
    axios
      ...
      else
      {
        ...
        axios
          .get(
            `${originURL}/users/teamMembers/${JSON.parse(localStorage.getItem("timesheet_user437")) &&  JSON.parse(localStorage.getItem("timesheet_user437")).details._id}`
          )
          .then((res) => {
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          axios.put(
                            `${originURL}/users/addTeamMembers/${JSON.parse(
