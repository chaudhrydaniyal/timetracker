          ...
          >
            <TableContainer>
              ...
              <div className="d-flex ml-3 mt-3 mb-1">
                ...
                <select style={{height:"40px",marginLeft:'2%',width:'30%'}}
                  onClick={(e) => {
                ...
                <div style={{ display:"flex", height:"40px",marginLeft:'2%'}}>
                    ...
                    try {
                      axios
                        .post(`${originURL}/email/sendmail`, 
                          ...
                          .map((b, index) => {
                            return {
                              Date: moment(new Date(b.date)).format("DD-MM-YYYY"),
                              Tasks: b.title,
