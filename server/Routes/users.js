...
const {allUsers,teamMembers,companyUsers,deleteUser,singleUser,updateUser, addTeamMember} = require('../Controllers/users')
...
//company data
router.get('/companydata/company',companyUsers)
